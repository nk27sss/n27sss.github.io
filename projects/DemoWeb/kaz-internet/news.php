...
<html>
<head>
	<title>Kaz Internet - Новости</title>
...
<header id="wrap">
	...
	<div class="navbar navbar-default  hr" style="background:#FEFEFE; border-top:none; ">
		...
		<li><a class="navbar" href="<?=$_SERVER[PHP_SELF];?>"><table><tr>
				...
				<td style="color:#344;"><h2 style="margin-top:0px; font-weight:bold;"> Kaz Internet</h2><b>Новости</b></td>
			</tr></table></a></li>
		<li>
			<div class='panel-body'>
				<span>Новости</span><span style="margin-right: 20px"></span>
			</div>
		</li>
		<?if($admin){?>
		<li>
			<a href="fileManager.php?f=news"><span class="glyphicon glyphicon-pencil"></span> Изменить контент</a>
		</li>
		<?}?>
...
<!--Файл news/index.html-->
<? include("news/index.html"); ?>
<!--Конец файла news/index.html-->
</div>
</div>
